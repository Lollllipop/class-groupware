...
public class AttendanceServiceImpl implements AttendanceService {
	...
	public ClassVO selectClass(int class_idx) throws Exception {
		ClassVO classList = classDAO.selectByIdx(class_idx);
	 ...
	 * @Override
	 * 
	 * @Transactional public void insert() throws Exception {
	 * attendanceMapper.insert(null); }
	 * 
	 * @Override
	 * 
	 * @Transactional public List<AttendanceVO> selectByIdx() throws Exception {
	 * return attendanceMapper.selectByIdx(null); }
	 */
