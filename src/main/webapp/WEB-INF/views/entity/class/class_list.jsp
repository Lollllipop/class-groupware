			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
									...
									<div class="card-image">
										<ul class="collection">
											<li class="collection-item avatar"><i
												class="material-icons circle blue">mode_edit</i> 
												<span class="title"> <a href="./class_update?class_idx=${classVO.class_idx}"  onclick="window.open(this.href, '_blanck', 'width=400, height=430, left=300, top=300'); return false">
												<!--  -->
												${classVO.class_name}</a></span>
												...
												<p style="float: left;">
													${classVO.class_about}<br> ${classVO.class_startdate} ~ ${classVO.class_enddate}
												...
												본인의 수업 리스트가 보이며, 수강 포기 버튼 안보임. 강사는 수업 포기할 권한 없음. 마스터가 있음 --> 
													...
													<button type="submit" class="btn btn-success" onclick="sub()">
													<i class="material-icons left">done</i>수강신청
													</button>
									
												
													<a href="./class_update?class_idx=${classVO.class_idx}"  onclick="window.open(this.href, 'classUp', 'width=400, height=430, left=300, top=300'); return false"> 
													<button class = "btn btn-danger">
													<i class="material-icons left">update</i>수업 수정
													</button></a>
													<button type="submit" class="btn btn-danger" onclick="location.href='delete?class_idx=${classVO.class_idx}'">
						...
						<form>
							<input type="hidden" id="StudentName" name ="user_idx" value="${aaa}">
							<input type="hidden" id="ClassName" name = "class_idx" value="${classVO.class_idx}">
						</form>
