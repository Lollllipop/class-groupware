...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons"
	rel="stylesheet">
<link rel="stylesheet" href="${contextPath}/resources/materialize/css/materialize.min.css"
...
<link rel="stylesheet"
	...
	media="print">
<!-- Theme style -->
<link rel="stylesheet" href="${contextPath}/resources/calendar/dist/css/AdminLTE.min.css">
...
<!-- 마스터와 강사의 작성/수정/삭제할 수 있는 일정관리 페이지 -->
	...
	<!-- jQuery 3 -->
	<script src="${contextPath}/resources/calendar/bower_components/jquery/dist/jquery.min.js"></script>
	<!-- jQuery UI 1.11.4 -->
	<script
	...
	<!-- fullCalendar -->
	<script src="${contextPath}/resources/calendar/bower_components/moment/moment.js"></script>
	<script
