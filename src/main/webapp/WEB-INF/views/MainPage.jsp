...
<body>
   ...
   <div class="container">
      ...
      <a href="/entity/auth/login"><img
         src="${contextPath}/resources/img/login.jpg" alt="..."
         class="img-responsive center-block"></a> <br> <br> 
         <a href="/entity/auth/signUp"><img
         src="${contextPath}/resources/img/joinmember.jpg" alt="..."
         class="img-responsive center-block"></a> <br> <br> <br>

      <div class="img_box" style="width: 330px; margin: auto;">
         <a href="#"><img src="${contextPath}/resources/img/kakao.png"
            width="100" height="100" style="float: left; margin-right: 15px;"
            alt="..." class="img-responsive center-block"></a> <a href="#"><img
            src="${contextPath}/resources/img/google.png" width="100"
            height="100" style="float: left; margin-right: 15px;" alt="..."
            class="img-responsive center-block"></a> <a href="#"><img
            src="${contextPath}/resources/img/facebook.png" width="100"
            height="105" style="float: left;" alt="..."
